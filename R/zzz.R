.onLoad <- function(libname, pkgname) {
  op.fafbseg=list(
    ...
    fafbseg.skeletonuri="brainmaps://772153499790:fafb_v14:fafb_v14_16nm_v00c_split3xfill2_flatreseg2_skeletons32/teasar512_nnconn165_mc10000_prune10_thresh1000_sparse250_b"
