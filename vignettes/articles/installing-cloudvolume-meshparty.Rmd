...
You may also want to install [skeletor](https://github.com/schlegelp/skeletor), an package from Philipp Schlegel that helps you thin and skeletonise meshes yourself. This can produce more accurate results than you get using TESAR through meshparty, and does not depend on either. To install, do:
...
cntr = sk.contract(simp, SL=10, WH0=2, iter_lim=4, epsilon=0.05, precision=1e-6, progress=False)
