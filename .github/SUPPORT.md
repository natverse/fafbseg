...
Thanks for using fafbseg. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the fafbseg package](https://github.com/natverse/fafbseg/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/fafbseg/issues/new).
* If you're not sure:
